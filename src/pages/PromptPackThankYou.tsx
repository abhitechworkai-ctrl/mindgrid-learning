    ...
    <div id="main-content" className="min-h-screen bg-gradient-to-b from-blue-50 to-white py-16">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Card className="p-8 md:p-12 text-center">
          <div className="w-20 h-20 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-6 animate-bounce-subtle">
            <CheckCircle className="w-12 h-12 text-blue-600" aria-hidden="true" />
          </div>
          ...
          <p className="text-lg text-gray-700 mb-8 leading-relaxed-body animate-fade-up stagger-2">
            Thank you for purchasing your AI Prompt Pack.
          </p>

          <div className="bg-blue-50 border-2 border-primary-accent rounded-lg p-6 mb-8 animate-fade-up stagger-3">
            <div className="flex items-center justify-center mb-4">
              <Mail className="w-8 h-8 text-primary-accent mr-3" aria-hidden="true" />
            ...
            <p className="text-base text-gray-700 leading-relaxed-body">
              We've sent your Prompt Pack access link to the email address you provided during checkout.
          ...
          <div className="space-y-4 text-left text-base text-gray-700 mb-8 animate-fade-up stagger-4">
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-600 mr-3 flex-shrink-0 mt-0.5" aria-hidden="true" />
                <span>Access link will be sent to your email within 5 minutes</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-600 mr-3 flex-shrink-0 mt-0.5" aria-hidden="true" />
                <span>Click the link to access your AI Prompt Pack</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-600 mr-3 flex-shrink-0 mt-0.5" aria-hidden="true" />
                <span>Download and use the prompts for enhanced learning</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-600 mr-3 flex-shrink-0 mt-0.5" aria-hidden="true" />
