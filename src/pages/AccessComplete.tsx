...
export function AccessComplete() {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 animate-fade-up">
          ...
          <div className="flex items-center justify-center gap-3 mb-2 flex-wrap">
            ...
            <Badge variant="secondary" className="text-sm px-3 py-1">Complete Pack</Badge>
          </div>
          <h1 className="text-3xl md:text-4xl font-bold text-primary-navy mb-2">
            {subjectName} Complete Exam Pack
          </h1>
              ...
              <div className="flex-grow">
                <div className="flex items-center mb-2">
                  ...
                  <h3 className="font-semibold text-primary-navy">
                    📚 {subjectName} Complete Pack
                  </h3>
                </div>
                <p className="text-sm text-gray-600">
                  Complete study materials for exam preparation
                </p>
              </div>
